...
FOOD_ACTIONS = [
    "Apples", "Bread", "Broccoli", "Carrots", "Cheese", "Chicken", "Chickpeas",
    "Eggs", "Milk", "Mushrooms", "Onions", "Oranges", "Potatoes", "Tomatoes",
    "Plant-Based Milk", "Lentils", "Beef", "Lamb", "Pork", "Yogurt"
]
ACTION_LIMITS = {
