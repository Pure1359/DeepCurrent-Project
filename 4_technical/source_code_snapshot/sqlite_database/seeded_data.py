...
action_types = [
    ...
    ("Chicken | breast | raw", "food", "KG", 6.276),
    ("Chicken | leg | raw", "food", "KG", 2.352),
    ("Chicken | whole | raw", "food", "KG", 3.927),
    ...
    ("Cheese | firm | 45% fat", "food", "KG", 4.114),
    ("Cheese | Mozzarella | 30% fat", "food", "KG", 4.114),
    ("Butter | salt added", "food", "KG", 3.259),
    ("Eggs | chicken | free-range | raw", "food", "KG", 1.228),
    ("Milk | whole | 3.5% fat", "food", "KG", 0.341),
    ("Milk | partly skimmed | 1.5% fat", "food", "KG", 0.278),
    ("Cream | whipping | 38% fat", "food", "KG", 1.665),
    ("Salmon | atlantic | raw", "food", "KG", 1.990),
    ...
    ("Lamb | leg | raw", "food", "KG", 38.144),
    ("Lamb | average | raw", "food", "KG", 38.144),
    ("Pork | loin | lean | raw", "food", "KG", 5.622),
    ("Pork | tenderloin | raw", "food", "KG", 7.448),
...
FOOD_ACTIONS = [
    "Apple | raw", "Bread | white | roll", "Broccoli | raw",
    "Carrot | raw", "Cheese | firm | 45% fat", "Chicken | whole | raw",
    "Chickpeas | canned", "Eggs | chicken | free-range | raw",
    "Milk | whole | 3.5% fat", "Mushroom | raw", "Onion | raw", "Orange | raw",
    "Potato | raw", "Tomato | ripe | raw", "Oat milk",
    "Green lentils | dried", "Beef mince | 10-15% fat | raw", "Lamb | average | raw",
